...
document.getElementById('getallform').addEventListener('submit',function(e){
    $.ajax({
        ...
        method:'GET',
        url:"http://localhost/ejemplos/ServidorPHP.php/article",
...
document.getElementById('getidform').addEventListener('submit', function(e){
    ...
    $.ajax({
        method:'GET',
        url:"http://localhost/ejemplos/ServidorPHP.php/article/"+idbuscar,
        success:function(data){
            let articulo=new Article();
...
document.getElementById('putidform').addEventListener('submit',function(e){
    ...
    $.ajax({
        method:'PUT',
        data:datosput,
        url:"http://localhost/ejemplos/ServidorPHP.php/article/"+idmodificar,
        success:function(data){
            alert('Modificado');
        }
    }).fail(function(){
